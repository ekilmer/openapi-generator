...
export class DefaultApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param inlineBody2 
     */
    public async filePost(inlineBody2?: InlineBody2, _options?: Configuration): Promise<RequestContext> {
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(inlineBody2, "InlineBody2", ""),
            contentType
        );
     ...
     * @param inlineBody1 
     */
    public async petsFilteredPatch(inlineBody1?: InlineBody1, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        requestContext.setHeaderParam("Content-Type", contentType);
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(inlineBody1, "InlineBody1", ""),
            contentType
        );
        requestContext.setBody(serializedBody);
     ...
     * @param inlineBody 
     */
    public async petsPatch(inlineBody?: InlineBody, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        requestContext.setHeaderParam("Content-Type", contentType);
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(inlineBody, "InlineBody", ""),
            contentType
        );
        requestContext.setBody(serializedBody);
